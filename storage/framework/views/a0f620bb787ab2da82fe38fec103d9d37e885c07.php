    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
       <div class="modal-content">
          ...
          <div class="modal-body">
             ...
             <form id="ajaxEditForm" class="" action="<?php echo e(route('user.gateway.offline.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php /**PATH /home/cpftxworld/menumakker.com/resources/views/user/gateways/offline/edit.blade.php ENDPATH**/ ?>