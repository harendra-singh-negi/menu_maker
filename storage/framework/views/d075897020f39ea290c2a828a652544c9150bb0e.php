...
<div class="login-page">
    ...
    <div class="form">
        ...
        <form class="login-form" action="<?php echo e(route('admin.login.submit')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <input type="text" name="username" value="" placeholder="<?php echo e(__('username')); ?>"/>
...
<?php /**PATH /home/cpftxworld/menumakker.com/resources/views/admin/login.blade.php ENDPATH**/ ?>